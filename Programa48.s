...
// Descripción: Este programa mide el tiempo de ejecución de una función personalizada utilizando la llamada al sistema `clock_gettime`. 
// Calcula la diferencia en nanosegundos entre el tiempo inicial y final, mostrando el resultado del cálculo y el tiempo transcurrido. 
// Este programa es útil para evaluar el rendimiento de funciones en entornos de bajo nivel.
// Autor: Diego Enrique Maya Lopez
// Fecha: 19/11/2024
// Video: https://asciinema.org/a/Bg8SRGSMESveieLORiDDG6PUD
//============================================================
/*
#include <stdio.h>
